...
const Mailfirst=()=> {
  ...
  const EmailSubmitHandler = (event) => {
    ...
    fetch(
      `https://react-http-1fabf-default-rtdb.firebaseio.com/email-box/${receivedEmail}/received.json`,
      {
        method: "POST",
        body: JSON.stringify({
          ...objRecieved,
      ...
      fetch(
        `https://react-http-1fabf-default-rtdb.firebaseio.com/email-box/${receivedEmail}/received/${data.name}.json`,
        {
          method: "PATCH",
          body: JSON.stringify({
            id: data.name,
    ...
    fetch(
      `https://react-http-1fabf-default-rtdb.firebaseio.com/email-box/${emailSender}/sent.json`,
      {
        method: "POST",
        body: JSON.stringify({
          ...objSent,
      ...
      fetch(
        `https://react-http-1fabf-default-rtdb.firebaseio.com/email-box/${emailSender}/sent/${data.name}.json`,
        {
          method: "PATCH",
          body: JSON.stringify({
            id: data.name,
